...
/* Recebe a matriz em jogo e a queue.
   Fas as mudanças ao tabuleiro atual que podem ser inferidas pelas
...
/* Recebe a matriz a ser alterada, o valores correspondentes a linha e a coluna 
...
/* Recebe uma matriz e uma queue.
   Utiliza a funçao ajuda até ela nã fazer alterações.
